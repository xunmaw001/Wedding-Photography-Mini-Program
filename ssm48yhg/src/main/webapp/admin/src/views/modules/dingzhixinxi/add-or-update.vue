<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="定制类型" prop="dingzhileixing">
          <el-select :disabled="ro.dingzhileixing" v-model="ruleForm.dingzhileixing" placeholder="请选择定制类型">
            <el-option
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.dingzhixiangqing" label="定制详情" prop="dingzhixiangqing">
                    <span v-html="ruleForm.dingzhixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.dingzhixiangqing = this.ruleForm.dingzhixiangqing.replace(reg,'../../../ssm48yhg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
